...
namespace UIUniversal
{
    ...
    public class CoverFlow : ItemsControl, INotifyPropertyChanged
    {
        ...
        private const double _threshold = 120.0; // Higher values == lower sensitivity
    ...
    //        items = new List<CoverFlowItem>();
    //        SingleItemDuration = new Duration(TimeSpan.FromMilliseconds(900));
    //        PageDuration = new Duration(TimeSpan.FromMilliseconds(1150));
    //        duration = SingleItemDuration;
    //        EasingFunction = new CubicEase();
    //    }
    ...
    //    }
    //    public static readonly DependencyProperty SpaceBetweenItemsProperty =
    //        DependencyProperty.Register("SpaceBetweenItems", typeof(double), typeof(CoverFlow), new PropertyMetadata(20d, new PropertyChangedCallback(CoverFlow.OnValuesChanged)));
    ...
    //    }
    //    public static readonly DependencyProperty RotationAngleProperty =
    //        DependencyProperty.Register("RotationAngle", typeof(double), typeof(CoverFlow), new PropertyMetadata(60d, new PropertyChangedCallback(CoverFlow.OnValuesChanged)));
    ...
    //    void CoverFlow_ManipulationStarted(object sender, ManipulationStartedRoutedEventArgs manipulationStartedRoutedEventArgs)
    //    {
    //        _distance = 0.0;
    //        _begin = true;
    //    }
        
    //    void CoverFlow_ManipulationDelta(object sender, ManipulationDeltaRoutedEventArgs manipulationDeltaRoutedEventArgs)
    //    {
    //        _distance += manipulationDeltaRoutedEventArgs.Delta.Translation.X;
    ...
    //            if (manipulationDeltaRoutedEventArgs.Delta.Translation.X < 0 && this.SelectedIndex < Items.Count - 1)
    //                NextItem();
    //            else if (manipulationDeltaRoutedEventArgs.Delta.Translation.X > 0 && this.SelectedIndex > 0)
    //                PreviousItem();
    //        }
    //    }
